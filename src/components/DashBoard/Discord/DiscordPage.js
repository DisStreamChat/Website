		...
		<div>
			...
			<div className="settings-body">
				{Object.keys(userDiscordInfo || {}).length ? (
					<>
						<div className="plugin-section-title" style={{paddingLeft: ".5rem", margin: 0}}>Server</div>
							...
							{userConnectedGuildInfo ? (
								!userConnectedGuildInfo.isMember ? (
									<div className="not-member">
										...
										<A
											href={`https://api.disstreamchat.com/v2/discord/invite?guild=${userConnectedGuildInfo?.id}`}
										>
