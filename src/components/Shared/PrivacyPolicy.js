...
const PrivacyPolicy = () => {
	return (
		<div class="privacy-policy">
			<h1 className="biggest">DisStreamChat Privacy Policy</h1>

			<p>
				At DisStreamChat, accessible from{" "}
				<A href="https://disstreamchat.com" newTab>
					https://disstreamchat.com
				</A>
				, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is
				collected and recorded by DisStreamChat and how we use it.
			</p>

			<p>
				If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at{" "}
				<a href="mailto: contact@disstreamchat.com">contact@disstreamchat.com</a>.
			</p>
			...
			<p>
				...
				that they shared and/or collect in DisStreamChat. This policy is not applicable to any information collected offline or via channels
			...
			<p>
				DisStreamChat follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
			...
			<p>You may consult this list to find the Privacy Policy for each of the advertising partners of DisStreamChat.</p>
			...
			<p>
				...
				advertisements and links that appear on DisStreamChat, which are sent directly to users' browser. They automatically receive your IP
			...
			<p>Note that DisStreamChat has no access to or control over these cookies that are used by third-party advertisers.</p>

			<h2>Third Party Privacy Policies</h2>

			<p>
				DisStreamChat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
			...
			<p>
				DisStreamChat does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that
